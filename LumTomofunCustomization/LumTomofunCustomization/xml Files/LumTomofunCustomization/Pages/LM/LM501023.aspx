<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" CodeFile="LM501023.aspx.cs" Inherits="Pages_LM501023" %>

<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>

<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%"
        TypeName="LumTomofunCustomization.Graph.LUMShopifySettlementTransactionProcess"
        PrimaryView="SettlementTransaction">
        <CallbackCommands>
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
        ...
        <Levels>
            <px:PXGridLevel DataMember="SettlementTransaction">
                <Columns>
                    ...
                    <px:PXGridColumn DataField="PayoutDate" />
