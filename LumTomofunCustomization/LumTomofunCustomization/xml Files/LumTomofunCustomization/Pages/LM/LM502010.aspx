...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="LUMTomofunCustomization.Graph.LUM3PLINReconciliationProc" PrimaryView="Filter">
		<CallbackCommands>
		</CallbackCommands>
	</px:PXDataSource>
</asp:Content>
					...
					<px:PXGrid ID="grid1" runat="server" DataSourceID="ds" Width="100%" Height="150px" SkinID="Inquire" AllowAutoHide="false" NoteIndicator="false" FilesIndicator="false">
						<Levels>
							<px:PXGridLevel DataMember="TopestReconciliation">
								...
								<px:PXGridColumn DataField="TranDate" Width="90" DisplayFormat="g" ></px:PXGridColumn>
