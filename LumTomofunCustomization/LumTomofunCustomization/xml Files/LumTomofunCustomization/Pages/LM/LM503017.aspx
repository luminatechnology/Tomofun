<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" CodeFile="LM503017.aspx.cs" Inherits="Pages_LM503017" %>

<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>

<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%"
        TypeName="LumTomofunCustomization.Graph.LUMAmazon_JPPaymentUploadProcess"
        ...
        <Levels>
            <px:PXGridLevel DataMember="PaymentTransactions">
                <Columns>
                    ...
                    <px:PXGridColumn DataField="COD"></px:PXGridColumn>
                    <px:PXGridColumn DataField="CODFee"></px:PXGridColumn>
                    <px:PXGridColumn DataField="CODItemCharge"></px:PXGridColumn>
                    <px:PXGridColumn DataField="Points"></px:PXGridColumn>
