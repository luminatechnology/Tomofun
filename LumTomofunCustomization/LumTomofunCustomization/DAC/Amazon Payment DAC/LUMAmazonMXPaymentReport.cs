...
{
    [Serializable]
    [PXCacheName("LUMAmazonMXPaymentReport")]
    public class LUMAmazonMXPaymentReport : IBqlTable
    {
        #region Selected
        [PXBool()]
        ...
        [PXUIField(DisplayName = "fecha/hora")]
        ...
        [PXUIField(DisplayName = "Id. de liquidación")]
        ...
        [PXUIField(DisplayName = "Id. del pedido")]
        ...
        #region ProductSales
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "ventas de productos")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "impuesto de ventas de productos")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "créditos de envío")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "impuesto de abono de envío")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "créditos por envoltorio de regalo")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "impuesto de créditos de envoltura")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "Tarifa reglamentaria")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "Impuesto sobre tarifa reglamentaria")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "descuentos promocionales")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "impuesto de reembolsos promocionales")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "impuesto de retenciones en la plataforma")]
        ...
        #region SellingFees
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "tarifas de venta")]
        ...
        #region Fbafees
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "tarifas fba")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "tarifas de otra transacción")]
