...
{
    [Serializable]
    [PXCacheName("LUMAmazonBEPaymentReport")]
    public class LUMAmazonBEPaymentReport : IBqlTable
    {
        #region Selected
        [PXBool()]
        ...
        [PXUIField(DisplayName = "Identifiant du paiement")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "taxe de ventes prélevée")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "crédits d’emballage-cadeau")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "Total des réductions")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "Taxe Marketplace Facilitator")]
        ...
        #region Fbafees
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "Frais pour le service Expédié par Amazon")]
        ...
        [PXUIField(DisplayName = "API_Marketplace")]
