...
{
    [Serializable]
    [PXCacheName("LUMAmazonSEPaymentReport")]
    public class LUMAmazonSEPaymentReport : IBqlTable
    {
        #region Selected
        [PXBool()]
        ...
        [PXUIField(DisplayName = "datum/tid")]
        ...
        [PXUIField(DisplayName = "reglerings-id")]
        ...
        [PXUIField(DisplayName = "beställnings-id")]
        ...
        [PXUIField(DisplayName = "beskrivning")]
        ...
        #region ProductSales
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "försäljning av produkter")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "Inkasserad moms")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "fraktkrediter")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "krediter för presentinslagning")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "kampanjrabatter")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "Skatt för marknadsplatsförmedlare")]
        ...
        #region SellingFees
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "försäljningsavgifter")]
        ...
        #region Fbafees
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "fba-avgifter")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "övriga transaktionsavgifter")]
