...
{
    [Serializable]
    [PXCacheName("LUMAmazonJPPaymentReport")]
    public class LUMAmazonJPPaymentReport : IBqlTable
    {
        #region Selected
        [PXBool()]
        ...
        #region ReportType
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "トランザクションの種類")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "ギフト包装手数料")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "ギフト包装クレジットの税金")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "プロモーション割引額")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "プロモーション割引の税金")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "源泉徴収税を伴うマーケットプレイス")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "トランザクションに関するその他の手数料")]
        ...
        #region CODFee
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "COD Fee")]
        public virtual string CODFee { get; set; }
        public abstract class cODFee : PX.Data.BQL.BqlString.Field<cODFee> { }
        #endregion

        #region CODItemCharge
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "calculated")]
        public virtual string CODItemCharge { get; set; }
        public abstract class cODItemCharge : PX.Data.BQL.BqlString.Field<cODItemCharge> { }
        #endregion

        #region Points
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "Amazonポイントの費用")]
        public virtual string Points { get; set; }
        public abstract class points : PX.Data.BQL.BqlString.Field<points> { }
        #endregion
