...
{
    [Serializable]
    [PXCacheName("LUMAmazonFRPaymentReport")]
    public class LUMAmazonFRPaymentReport : IBqlTable
    {
        #region Selected
        [PXBool()]
        ...
        [PXUIField(DisplayName = "date/heure")]
        ...
        [PXUIField(DisplayName = "numéro de versement")]
        ...
        [PXUIField(DisplayName = "numéro de la commande")]
        ...
        #region ProductSales
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "ventes de produits")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "Taxes sur la vente des produits")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "crédits d'expédition")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "taxe sur les crédits d’expédition")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "crédits sur l'emballage cadeau")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "Taxes sur les crédits cadeaux")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "Rabais promotionnels")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "Taxes sur les remises promotionnelles")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "Taxes retenues sur le site de vente")]
        ...
        #region SellingFees
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "frais de vente")]
        ...
        #region Fbafees
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "Frais Expédié par Amazon")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "autres frais de transaction")]
