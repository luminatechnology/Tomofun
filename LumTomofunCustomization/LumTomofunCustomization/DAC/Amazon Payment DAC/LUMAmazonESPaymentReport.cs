...
{
    [Serializable]
    [PXCacheName("LUMAmazonESPaymentReport")]
    public class LUMAmazonESPaymentReport : IBqlTable
    {
        #region Selected
        [PXBool()]
        ...
        [PXUIField(DisplayName = "fecha y hora")]
        ...
        [PXUIField(DisplayName = "identificador de pago")]
        ...
        [PXUIField(DisplayName = "número de pedido")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "abonos de envío")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "impuestos por abonos de envío")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "abonos de envoltorio para regalo")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "devoluciones promocionales")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "impuesto retenido en el sitio web")]
        ...
        #region Fbafees
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "tarifas de Logística de Amazon")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "tarifas de otras transacciones")]
