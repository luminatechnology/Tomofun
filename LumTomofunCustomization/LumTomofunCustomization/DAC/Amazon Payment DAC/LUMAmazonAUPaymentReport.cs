...
{
    [Serializable]
    [PXCacheName("LUMAmazonAUPaymentReport")]
    public class LUMAmazonAUPaymentReport : IBqlTable
    {
        #region Selected
        [PXBool()]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "sales tax collected")]
        ...
        [PXDBString(20, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "low value goods")]
